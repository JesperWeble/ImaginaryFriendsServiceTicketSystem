...
- Create Angular project with ng: `ng new imaginaryfriendsserviceticketsystem.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`imaginaryfriendsserviceticketsystem.client.esproj`).
